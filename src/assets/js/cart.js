var app = window.app || {},
business_paypal = 'me@hectorcyc.com'; // aquí va tu correo electrónico de paypal
...
(function($){
	...
	app.createProducts = function(){
		var productos = [
			{
				id : 1,
				img : 'https://s3.amazonaws.com/nikeinc/assets/48622/2015-Nike-Mag-02_hd_1600.jpg?1445446034',
				name : 'Tenis Nike',
				price : 99.00,
			...
			{
				id : 2,
				name : 'Pantalla Samsung 50"',
				img : 'https://images-na.ssl-images-amazon.com/images/I/81bmiMCOISL._SL1500_.jpg',
				price : 199.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 2
			},
			{
				id : 3,
				name : 'iPhone XS 512 GB Telcel',
				img : 'https://i.amz.mshcdn.com/W2PMCqce3qoOreCQk4muODiJskQ=/fit-in/1440x0/https%3A%2F%2Fblueprint-api-production.s3.amazonaws.com%2Fuploads%2Fcard%2Fimage%2F847201%2F3a5c458f-5022-4ad1-b2d9-ceab8cf73a64.jpg',
				price : 1099.00,
				desc : 'Libertad 5oz BU 1998 Contains 1 Libertad 5oz BU brilliant uncirculated .999 fine Silver. In capsule The same coin as you see in this picture. We only Ship to the US, and is FREE Shipping Shipping time 5-7 business days via UPS express with tracking and insurance. Payments only via Paypal.',
				stock : 1
			},
